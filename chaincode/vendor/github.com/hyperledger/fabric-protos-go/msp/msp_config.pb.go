...
type FabricCryptoConfig struct {
	...
	// IdCopyRightIDentifierHashFunction is a string representing the hash function
	// to be used during the computation of the identity identifier of an MSP identity.
	// Allowed values are "SHA256", "SHA384" and "SHA3_256", "SHA3_384".
	IdCopyRightIDentifierHashFunction string   `protobuf:"bytes,2,opt,name=identity_identifier_hash_function,json=idCopyRightIDentifierHashFunction,proto3" json:"identity_identifier_hash_function,omitempty"`
	XXX_NoUnkeyedLiteral           struct{} `json:"-"`
	XXX_unrecognized               []byte   `json:"-"`
	XXX_sizecache                  int32    `json:"-"`
}
...
func (m *FabricCryptoConfig) GetIdCopyRightIDentifierHashFunction() string {
	if m != nil {
		return m.IdCopyRightIDentifierHashFunction
	}
	return ""
}
